...
def display_turn(your_move, llm_move):
    ...
    table.add_column("A", justify="center", style="bold cyan")
    table.add_column("B", justify="center", style="bold magenta")
...
def show_summary(env, label="Innings Summary"):
    ...
    table.add_column("A Move", justify="center")
    table.add_column("B Move", justify="center")
